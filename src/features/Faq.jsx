...
const Faq = () => {
  return (
    <section className='faq__section py-5 clear'>
      <div className='container'>
        <h2 className='page__heading mb-2'>Frequently Asked Questions...</h2>
        ...
        <div className='row mt-5 gx-5'>
          <div data-aos='fade-up' data-aos-duration='1000' className='col-lg-5'>
            ...
            >
              <circle cx='431.39281' cy='548' r='46' fill='#800080' />
              <path
          ...
          <div className='col-lg-7 d-flex align-items-center mt-5 mt-lg-0'>
            <div
            ...
            >
              ...
              >
                ...
                >
                  <div className='accordion-body'>
                    Do you think it’s possible to calculate the exact cost for
                    website development? Website development will be fully
                    customizable, tailoring to the client’s requirements.
                  </div>
                </div>
              </div>
                ...
                >
                  <div className='accordion-body'>
                    <p>
                      ...
                      maintenance would help in ensuring your website’s
                      security, invite new visitors, boost traffic and more.
                    </p>
                    <p className='mb-0'>
                      Of course, i can help you out with proper and professional
                      website maintenance in addition to development as it
                      supports in achieving stabilized growth, keeping your
                      business inclined.
                    </p>
                  </div>
                </div>
              ...
              >
                ...
                >
                  <div className='accordion-body'>
                    <p className='mb-0'>
                      Yes, we ensure to develop a responsive website that would
                      make your visitors appealing and deliver an optimized
                      browsing experience.
                    </p>
                  </div>
                </div>
              ...
              >
                ...
                >
                  <div className='accordion-body'>
                    <p className='mb-0'>
                      I can work on it depending on your requirements. We would
                      recommend developing a website with a few pages as it
                      would help in optimizing your website with SEO in future
                      and for single page websites, it is quite daunting to add
              ...
              >
                ...
                >
                  <div className='accordion-body'>
                    <p className='mb-0'>
                      My payment steps are quite easy and secure with
                      transparency. We accept payments through secure payment
                      gateways such as Payoneer, Wise.com or Upwork direct
                      contract.
                    </p>
                  </div>
                </div>
